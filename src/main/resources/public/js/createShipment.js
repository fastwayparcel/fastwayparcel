...
document.body.addEventListener("click", function (e) {
  ...
  if (target.classList.contains("order-stage-icon")) {
    changeStage(target.parentElement.parentElement.parentElement);
...
function changeStage(selectedStage) {
  for (let i = 0; i < orderStages.length; i++) {
    orderStages[i].children[0].classList.add("text-blue");
    orderStages[i].children[1].children[0].classList.replace(
      "background-primary-light",
      "background-primary"
    );
    orderStages[i].children[1].children[0].children[0].style.display = "none";
    orderStages[i].children[1].children[0].children[1].style.display = "block";
...
function reset() {
  for (let i = 0; i < orderStages.length; i++) {
    orderStages[i].children[0].classList.remove("text-blue");
    orderStages[i].children[1].children[0].classList.replace(
      "background-primary",
      "background-primary-light"
    );
    orderStages[i].children[1].children[0].children[0].style.display = "block";
    orderStages[i].children[1].children[0].children[1].style.display = "none";
    orderStages[i].children[1].children[0].children[1].textContent = "check";
  }
}
