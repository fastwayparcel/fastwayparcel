let shipmentId = new URLSearchParams(window.location.search).get("tracking-id");
...
function getShipmentHistory(shipmentId) {
  ...
  shipmentHistoryXhr.open("GET", `http://127.0.0.1/shipment/${shipmentId}/histories/`, true);
